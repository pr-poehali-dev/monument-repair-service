...
export default function StructuredData() {
  const structuredData = {
    ...
    "address": [
      ...
      {
        "@type": "PostalAddress",
        "streetAddress": "ул. Каффайская, 69, рынок «Эдельвейс», павильон 33",
        "addressLocality": "Мариуполь",
        "addressRegion": "Донецкая Народная Республика",
        "addressCountry": "RU"
      },
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Стоимость зависит от материала, размера и сложности работ. Базовые памятники из гранита Карелия начинаются от 25 000 руб, премиум материалы (Чёрный Абсолют, Красный Лезники) — от 45 000 руб. Точную цену рассчитаем после выбора материала и формы."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "У нас три магазина: в Мариуполе (Киевский рынок, павильон 278, мкрн Восточный), в Мариуполе (ул. Каффайская, 69, рынок «Эдельвейс», павильон 33) и в Таганроге (ул. Пархоменко 7Г). Работаем ежедневно. Телефоны: +7 (949) 073-23-15, +7 (917) 334-70-22."
        }
      }
    ]
  };
