...
const faqData = [
  {
    ...
    answer: "Стоимость изготовления памятников в Мариуполе зависит от материала, размера и сложности работ. Базовые памятники из гранита Карелия начинаются от 25 000 руб, премиум материалы (Чёрный Абсолют, Красный Лезники) — от 45 000 руб. Точную цену на изготовление памятника в Мариуполе рассчитаем после выбора материала и формы."
  },
  {
  ...
  },
  {
    ...
    answer: "Изготовление памятников в Мариуполе — наши магазины: Киевский рынок, павильон 278, мкрн Восточный и ул. Каффайская, 69, рынок «Эдельвейс», павильон 33 (вход с рынка и со стороны ул. Готфейской). Также работаем в Таганроге (ул. Пархоменко 7Г) и в Ростове-на-Дону (ул. Обсерваторная, 30). Работаем ежедневно. Телефоны для заказа изготовления и установки памятников: +7 (949) 073-23-15, +7 (917) 334-70-22."
  }
];
