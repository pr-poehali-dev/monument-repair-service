...
export default function Services() {
  const services = [
    {
      icon: "Hammer",
      title: "Изготовление памятников в Ростове-на-Дону",
    ...
    {
      icon: "Truck",
      title: "Установка памятников Ростов-на-Дону",
      description: "Профессиональная установка памятников с гарантией 3 года. Работаем в Ростове-на-Дону, Мариуполе, Таганроге, Мангуше, Володарском, Волновахе, Новоазовске. Включает фундамент, подставку, монтаж стелы и цветник.",
      price: "от 18 000 ₽"
    },
    {
      icon: "Wrench",
      title: "Ремонт памятников Ростов-на-Дону",
  ...
  return (
    <>
      <SEO 
        title="Услуги по изготовлению памятников в Ростове-на-Дону | Установка и ремонт | GK Granite"
        description="Полный спектр услуг по изготовлению, установке и ремонту памятников в Ростове-на-Дону. Художественная гравировка, реставрация, благоустройство захоронений. Гарантия качества. ☎️ +7 (949) 073-23-15"
        keywords="услуги изготовление памятников Ростов-на-Дону, установка памятников Ростов-на-Дону цена, ремонт памятников Ростов-на-Дону стоимость, реставрация памятников, гравировка портретов, благоустройство захоронений"
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-secondary mb-4">
                Услуги по изготовлению памятников в Ростове-на-Дону
              </h1>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ГК ГРАНИТ предоставляет полный комплекс услуг: изготовление, установка, ремонт и реставрация памятников 
                из гранита и мрамора в Ростове-на-Дону, Мариуполе, Таганроге, Мангуше, Володарском, Волновахе и Новоазовске
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl p-8 md:p-12">
              <h2 className="text-3xl font-bold text-secondary mb-6 text-center">
                Почему выбирают GK Granite для изготовления памятников в Ростове-на-Дону
              </h2>
            ...
            <div className="mt-16 text-center">
              <h3 className="text-2xl font-bold text-secondary mb-6">
                Закажите изготовление памятника в Ростове-на-Дону
              </h3>
